...
function Logo(){
    ...
    return(
        <motion.div className="grid size-10 shrink-0 place-content-center
                        rounded-md bg-indigo-600"
        layout>
            <svg id="logo-73" width="40" height="40" viewBox="0 0 60 40" 
            fill="none" xmlns="http://www.w3.org/2000/svg"> 
                <path d="M56.25 1.25C56.25 1.94036 56.8096 2.5 57.5 2.5H58.75C59.4404 2.5 60 1.94036 60 1.25C60 0.559648 59.4404 3.49691e-06 58.75 3.49691e-06H57.5C56.8096 3.49691e-06 56.25 0.559648 56.25 1.25Z" 
                    className="ccustom" fill="white">
                </path> 
...
function TitleSection({ open, user }) {
  return (
    <div className='mb-3 border-b pb-3 border-slate-300'>
        ...
        >
            ...
            <Logo/>
            {
                open && (
                    ...
                    >
                        <span className="block text-xs font-semibold">Admin Dashboard</span>
